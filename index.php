...
<body class="w-full relative h-full bg-white ">
  <div class="min-h-screen flex">
    <!-- SideBar -->
    <div class="w-96 h-[full] bg-blue-900 text-white flex flex-col justify-center font-Roboto text-xl" style="background-color: #1e3a8a;">
      <div class="p-4 flex items-center justify-center">
        <img src="/image/GP_du_Monde.png" href="#" alt="GP du Monde Logo" class=" cursor-pointer w-72 h-72">
      </div>
      ...
      <main class="flex justify-between gap-4 ">
        ...
        <section class="grid w-3/12">
          <div
            ...
            <h2 class="text-3xl font-bold mb-4 text-center text-white mt-3">Ajouter cargaison</h2>
            <div>
              <form action="" class="mt-20">
                ...
                <div class="mb-8">
                  <select name="cargaison" id="cargaison"
                    ...
                    <option value="">Type de cargaison</option>
  ...
  <footer
    ...
    © <a href="https://sonatelacademy.com" target="_blank">Sonatel Academy 2024 </a>, Tout droits réserves
  </footer>
